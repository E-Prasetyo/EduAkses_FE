...
const CourseDetail = () => {
  ...
  const ensureCourseData = (course) => {
    return {
      ...
      image: course.coverImage || course.thumbnail || course.image || '/api/placeholder/800/400',
      thumbnail: course.coverImage || course.thumbnail || course.image || '/api/placeholder/400/300',
        ...
        <div className="row">
          <div className="col-lg-8">
              ...
              <div className="mb-4">
                {isEditing ? (
                  ...
                  <div className="d-flex gap-2">
                    ...
                    <Button onClick={() => navigate(`/course/${id}/manage`)}>Manage Course</Button>
                  </div>
                )}
              </div>
            )}
            ...
            <div className="card mb-4">
              <img src={course.coverImage || course.thumbnail || course.image || '/api/placeholder/800/400'} alt={course.title} className="card-img-top" onError={e => { e.target.style.display = 'none'; }} />
              <div className="card-body">
                <div className="mb-4">
                  <h5>About This Course</h5>
                  <div className="course-description" style={{whiteSpace: 'pre-line', lineHeight: '1.7', fontSize: '1rem', color: '#333'}}>
              ...
              <div className="card-body">
                ...
                {!isEnrolled ? (
                  ...
                  <Button 
                    ...
                    className="w-100"
                  >
                    {isEnrolled ? 'Sudah Diikuti - Lanjut Belajar' : 'Continue Learning'}
                  </Button>
                )}
              </div>
            </div>
